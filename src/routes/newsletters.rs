...
pub async fn publish_newsletter(
    ...
    // Gathering confirmed subscribers to send them the newsletter.
...
async fn validate_credentials(
    ...
    // To protect from [timing attack](https://en.wikipedia.org/wiki/Timing_attack)
    // we create a fake password to run against the hasher incase the username does not exists
